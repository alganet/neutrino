...
#
# Usage:
#   bash test/build/mkapp.sh --testing <app.js> /tmp/a.cmd     # the two builds have
#   bash test/build/mkapp.sh --testing <app.js> /tmp/b.cmd     # to be --testing ones
#   python3 test/apparatus/vmpair.py /tmp/a.cmd /tmp/b.cmd 10      # prints every pair
#
