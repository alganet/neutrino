...
//
// Built `--overlay test/probe/nav-hermetic`, and that is what keeps this suite
...
//
// test/probe/neutrinoattack.js already tries this, at a host that never resolves --
// which test/probe/early-target.html's own comment says is not a test: the load fails
...
// what that document can then do, and test/probe/nav-target.html reports it through
...
// running in. test/probe/nav-target.html reads it: if it is defined over there, the
