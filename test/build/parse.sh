...
# test/probe/neutrinotest.js produced exactly that and nothing else.
...
// test/probe/neutrinoattack.js's planted record reads the same everywhere.
...
// reparse point; test/suite/winexec.ps1 asserts the platform fact underneath.
var delRemoved = [];
var delListed = [];
...
// is asserted here is the shape; test/suite/assemble.sh builds both and compares.
...
// reading, and test/suite/assemble.sh builds both and asserts they differ.
console.log("");
